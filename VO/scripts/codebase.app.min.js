    ...
    function () {
            ...
            if (S) {
              if (d) {
                var I, q = "y" === A ? s : r,
                  ...
                  ce = z + oe - le,
                  de = U(b ? M(B, z + ne - le - ae) : B, z, b ? N(R, ce) : R);
                S[A] = de, F[A] = de - z
              }
              if (u) {
                var he, ue = "x" === A ? s : r,
      ...
      const Pe = new Map,
        ...
        Ke = (e, t, i = !0) => {
          ...
          const o = ({
            ...
            i === t && (n = !0, t.removeEventListener(Me, o), Ue(e))
          };
            ...
            return function s(n) {
              ...
              for (let {
                ...
                for (const a of o)
                  if (a === r) return ft(n, {
                    delegateTarget: r
                  }), s.oneOff && pt.off(e, n.type, t, i), i.apply(r, [n])
            }
          }(e, i, r) : function (e, t) {
            return function i(s) {
              return ft(s, {
                delegateTarget: e
              }), i.oneOff && pt.off(e, s.type, t), t.apply(e, [s])
            }
          }(e, r);
      ...
      const pt = {
        ...
        off(e, t, i, s) {
          ...
          if (void 0 === o) {
            if (d)
              for (const i of Object.keys(l)) ht(e, l, i, t.slice(1));
      ...
      class ri extends vt {
        ...
        _addTouchEventListeners() {
          for (const e of wt.find(".carousel-item img", this._element)) pt.on(e, Ut, (e => e.preventDefault()));
          const e = {
      ...
      pt.on(document, ui, _i, (function (e) {
        ...
        for (const e of wt.getMultipleElementsFromSelector(this)) yi.getOrCreateInstance(e, {
          toggle: !1
        }).toggle()
      })), Xe(yi);
      const wi = "dropdown",
        ...
        _completeHide(e) {
          if (!pt.trigger(this._element, Li, e).defaultPrevented) {
            if ("ontouchstart" in document.documentElement)
              for (const e of [].concat(...document.body.children)) pt.off(e, "mouseover", Be);
      ...
      class cs {
        ...
        _applyManipulationCallback(e, t) {
          if (qe(e)) t(e);
            ...
            for (const i of wt.find(e, this._element)) t(i)
        }
      }
      const ds = ".bs.modal",
        hs = `hide${ds}`,
      ...
      class Ls extends vt {
        ...
        show(e) {
          this._isShown || this._isTransitioning || pt.trigger(this._element, fs, {
            relatedTarget: e
          }).defaultPrevented || (this._isShown = !0, this._isTransitioning = !0, this._scrollBar.hide(), document.body.classList.add(ws), this._adjustDialog(), this._backdrop.show((() => this._showElement(e))))
        }
        hide() {
        ...
        _showElement(e) {
          ...
          t && (t.scrollTop = 0), Re(this._element), this._element.classList.add(Es), this._queueCallback((() => {
            this._config.focus && this._focustrap.activate(), this._isTransitioning = !1, pt.trigger(this._element, gs, {
              relatedTarget: e
            })
      ...
      class Rs extends vt {
        ...
        show(e) {
          this._isShown || pt.trigger(this._element, Ns, {
            relatedTarget: e
          }).defaultPrevented || (this._isShown = !0, this._backdrop.show(), this._config.scroll || (new cs).hide(), this._element.setAttribute("aria-modal", !0), this._element.setAttribute("role", "dialog"), this._element.classList.add(Ts), this._queueCallback((() => {
            this._config.scroll && !this._config.backdrop || this._focustrap.activate(), this._element.classList.add(js), this._element.classList.remove(Ts), pt.trigger(this._element, Ms, {
              relatedTarget: e
            })
          }), this._element, !0))
        }
      ...
      class dn extends vt {
        ...
        show() {
          ...
          if (this._element.ownerDocument.documentElement.contains(this.tip) || (s.append(i), pt.trigger(this._element, this.constructor.eventName("inserted"))), this._popper = this._createPopper(i), i.classList.add(tn), "ontouchstart" in document.documentElement)
            for (const e of [].concat(...document.body.children)) pt.on(e, "mouseover", Be);
          this._queueCallback((() => {
      ...
      class kn extends vt {
        ...
        _process(e) {
          this._activeTarget !== e && (this._clearActiveClass(this._config.target), this._activeTarget = e, e.classList.add(bn), this._activateParents(e), pt.trigger(this._element, gn, {
            relatedTarget: e
          }))
        }
        _activateParents(e) {
      ...
      class Yn extends vt {
        ...
        _activate(e, t) {
          e && (e.classList.add(Wn), this._activate(wt.getElementFromSelector(e)), this._queueCallback((() => {
            "tab" === e.getAttribute("role") ? (e.removeAttribute("tabindex"), e.setAttribute("aria-selected", !0), this._toggleDropDown(e, !0), pt.trigger(e, On, {
              relatedTarget: t
            })) : e.classList.add(Hn)
        ...
        _deactivate(e, t) {
          e && (e.classList.remove(Wn), e.blur(), this._deactivate(wt.getElementFromSelector(e)), this._queueCallback((() => {
            "tab" === e.getAttribute("role") ? (e.setAttribute("aria-selected", !1), e.setAttribute("tabindex", "-1"), this._toggleDropDown(e, !1), pt.trigger(e, Sn, {
              relatedTarget: t
        ...
        _keydown(e) {
          ...
          let i;
          if ([In, qn].includes(e.key)) i = t[e.key === In ? 0 : t.length - 1];
          else {
      ...
      class lo extends vt {
        ...
        _setListeners() {
          pt.on(this._element, Un, (e => this._onInteraction(e, !0))), pt.on(this._element, Kn, (e => this._onInteraction(e, !1))), pt.on(this._element, Zn, (e => this._onInteraction(e, !0))), pt.on(this._element, Gn, (e => this._onInteraction(e, !1)))
        }
        _clearTimeout() {
        ...
        Go = function () {
          function e(t, i) {
            ...
            if (this.removePreventClickId = null, this.minScrollbarWidth = 20, this.stopScrollDelay = 175, this.isScrolling = !1, this.isMouseEntering = !1, this.scrollXTicking = !1, this.scrollYTicking = !1, this.wrapperEl = null, this.contentWrapperEl = null, this.contentEl = null, this.offsetEl = null, this.maskEl = null, this.placeholderEl = null, this.heightAutoObserverWrapperEl = null, this.heightAutoObserverEl = null, this.rtlHelpers = null, this.scrollbarWidth = 0, this.resizeObserver = null, this.mutationObserver = null, this.elStyles = null, this.isRtl = null, this.mouseX = 0, this.mouseY = 0, this.onMouseMove = function () {}, this.onWindowResize = function () {}, this.onStopScrolling = function () {}, this.onMouseEntered = function () {}, this.onScroll = function () {
                var e = Vo(s.el);
                s.scrollXTicking || (e.requestAnimationFrame(s.scrollX), s.scrollXTicking = !0), s.scrollYTicking || (e.requestAnimationFrame(s.scrollY), s.scrollYTicking = !0), s.isScrolling || (s.isScrolling = !0, Uo(s.el, s.classNames.scrolling)), s.showScrollbar("x"), s.showScrollbar("y"), s.onStopScrolling()
                ...
                Ko(s.el, s.classNames.scrolling), s.options.autoHide && (s.hideScrollbar("x"), s.hideScrollbar("y")), s.isScrolling = !1
              }, this.onMouseEnter = function () {
                s.isMouseEntering || (Uo(s.el, s.classNames.mouseEntered), s.showScrollbar("x"), s.showScrollbar("y"), s.isMouseEntering = !0), s.onMouseEntered()
              }, this._onMouseEntered = function () {
                Ko(s.el, s.classNames.mouseEntered), s.options.autoHide && (s.hideScrollbar("x"), s.hideScrollbar("y")), s.isMouseEntering = !1
                ...
                var t = Yo(s.el),
                  i = Vo(s.el);
                e.preventDefault(), e.stopPropagation(), Ko(s.el, s.classNames.dragging), t.removeEventListener("mousemove", s.drag, !0), t.removeEventListener("mouseup", s.onEndDrag, !0), s.removePreventClickId = i.setTimeout((function () {
            ...
            }(this._onMouseMove, 64), this.onWindowResize = No(this._onWindowResize, 64, {
              leading: !0
            }), this.onStopScrolling = No(this._onStopScrolling, this.stopScrollDelay), this.onMouseEntered = No(this._onMouseEntered, this.stopScrollDelay), this.init()
          }
          return e.getRtlHelpers = function () {
            ...
            void 0 === e && (e = "y"), this.axis[e].isOverflowing && !this.axis[e].scrollbar.isVisible && (Uo(this.axis[e].scrollbar.el, this.classNames.visible), this.axis[e].scrollbar.isVisible = !0)
          }, e.prototype.hideScrollbar = function (e) {
            void 0 === e && (e = "y"), this.axis[e].isOverflowing && this.axis[e].scrollbar.isVisible && (Ko(this.axis[e].scrollbar.el, this.classNames.visible), this.axis[e].scrollbar.isVisible = !1)
            ...
            void 0 === e && (e = "y");
            var t = this.axis[e];
            t.track.el && t.scrollbar.el && (t.track.rect = t.track.el.getBoundingClientRect(), t.scrollbar.rect = t.scrollbar.el.getBoundingClientRect(), this.isWithinBounds(t.track.rect) ? (this.showScrollbar(e), Uo(t.track.el, this.classNames.hover), this.isWithinBounds(t.scrollbar.rect) ? Uo(t.scrollbar.el, this.classNames.hover) : Ko(t.scrollbar.el, this.classNames.hover)) : (Ko(t.track.el, this.classNames.hover), this.options.autoHide && this.hideScrollbar(e)))
          }, e.prototype.onMouseLeaveForAxis = function (e) {
            void 0 === e && (e = "y"), Ko(this.axis[e].track.el, this.classNames.hover), Ko(this.axis[e].scrollbar.el, this.classNames.hover), this.options.autoHide && this.hideScrollbar(e)
